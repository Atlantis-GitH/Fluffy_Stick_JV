...
(function() {
    ...
    GM_addStyle(".cat-stickers#hap-css { left: 5px; background-image: url('https://image.jeuxvideo.com/stickers/p/1kki'); }\
    ...
    window.addEventListener('jvchat:activation', function(event) {
        if (document.URL.includes("jeuxvideo.com/messages-prives")){
            var oldstickssjvc = document.getElementById('old-stickjvc');
            oldstickssjvc && (oldstickssjvc.disabled = true);
            $(".new-stickers#"+currentDiv).hide(0);
        }
    });
    */
